...
export const AddExpenseDetails = () => {
...
return (
      ...
      <div onClick={setFalse} className="w-full p-5 pb-0  overflow-y-auto h-[400px]">
            ...
            <p className="text-xl font-bold">Add a expense</p>
            ...
            <div className=" ">
              ...
              <div className="mt-5">
                <div className="form-control w-full ">
                  <label className="label !py-1 text-xs">
                    <span className="label-text">Expenses title</span>
                  </label>
                  <input type="text" placeholder="Add title here..." className="border border-super-lighter-grey input  focus:outline-none w-full" />            
                </div>                                                        
              </div>
              ...
              <div className="mt-5">
                <div className="form-control w-full ">
                  <label className="label !py-1 text-xs">
                    <span className="label-text">Expenses description</span>
                  </label>
             ...
             <div className="mt-5">
                <div className="form-control w-full ">
                  ...
                  <input type="text" placeholder="Add expense here..." className="border border-super-lighter-grey input  focus:outline-none w-full" />            
                </div>                                                        
              </div>

              <div>
                <div className="flex items-center mb-1 mt-5">
                    <p className="text-super-text-primary text-sm">Date of expense</p> 
                </div>                     
