...
import { TripLeaderReviewSection } from './TripLeaderReviewSection';


export const TripLeaderProfileDetails = () => {
  ...
  return (
    ...
    <div className="bg-white p-12 w-full">
        ...
        <div className="grid grid-cols-2 gap-4 w-full mt-5">
                      <p className="border border-black rounded-lg py-2 text-center">Manage calendar</p>
                      <p className="bg-black text-white rounded-lg py-2 text-center ">Find trip</p>
         </div>
...
on the pocket too! Trust us, it can’t better than this.</p>
       ...
       <TripLeaderReviewSection></TripLeaderReviewSection>
    </div>
