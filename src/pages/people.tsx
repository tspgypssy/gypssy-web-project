...
import { LogoutPageModal } from "client/modules/dashboard/components/logout/LogoutPageModal";
import { PeoplePage } from "client/modules/dashboard/components/people/PeoplePage";
import { PersonDetailsModal } from "client/modules/peoplefeed/components/persondetails/PersonDetailsModal";
...
const Home = () => {
  ...
  return (
    ...
    { modal === 'logout' && <LogoutPageModal /> }
    { modal === 'person-details' && <PersonDetailsModal /> }
